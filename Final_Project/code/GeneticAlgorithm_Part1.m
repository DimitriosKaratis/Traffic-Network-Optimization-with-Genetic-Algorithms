...
%% Main script for the Genetic Algorithm implementation (Part 1, without variance in V)
...
title('Fitness Evolution Across Generations (NO VARIANCE IN V)', 'FontSize', 18);
